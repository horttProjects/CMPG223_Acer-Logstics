namespace Information_Management_System_Acer_Logistics_
{
	partial class AcerLogisics
	{
		...
		private void InitializeComponent()
		{
			...
			this.reports.Size = new System.Drawing.Size(718, 491);
			...
			// receiveSo
			// 
			this.receiveSo.Controls.Add(this.panel1);
			this.receiveSo.Controls.Add(this.textBox2);
			this.receiveSo.Controls.Add(this.comboBox2);
			this.receiveSo.Controls.Add(this.SortcomboBox);
			this.receiveSo.Controls.Add(this.groupBox1);
			...
			this.Add.Name = "Add";
			this.Add.Size = new System.Drawing.Size(200, 134);
			this.Add.TabIndex = 0;
			...
			this.panel1.Location = new System.Drawing.Point(384, -66);
			...
			this.groupBox1.Location = new System.Drawing.Point(419, 6);
			...
			this.receiveSo.ResumeLayout(false);
			this.receiveSo.PerformLayout();
